const GlassCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -left-[23%] z-10 h-[75%] w-[150%] rounded-b-full bg-gradient-to-r from-transparent via-glassElementGlowHelper to-transparent blur-xl"></div>
      <div className="absolute z-20 text-bannerGradientStart">{children}</div>
    </div>
  );
};
